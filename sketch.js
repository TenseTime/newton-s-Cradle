...
function draw() {
  ...
  background(255);
  textSize(25);
  text("controls are Right arrow and Left arrow", 250,100);
  roof.display()
  rope1.display();
  rope2.display();
  rope3.display();
...
function keyPressed () {
    ...
    Matter.Body.applyForce(bobObject5.body, bobObject5.body.position, {x:100, y:205});
  }
}
